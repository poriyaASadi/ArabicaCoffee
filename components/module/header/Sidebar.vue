        ...
        <div class="px-3">
            ...
            <div class="py-3 border-b border-[#F3F4F6] dark:border-[#FFFFFF1A]">
                <ul class="font-dana colors-primary">
                    ...
                    <li class="my-3 ">
                        <div
                            class="flex items-center flex-row-reverse gap-x-2  rounded-sm cursor-pointer justify-between  p-3">
                            <div class="flex items-center flex-row-reverse gap-x-2">
                    ...
                    <li class="my-3">
                        <div class="flex items-center flex-row-reverse gap-x-2  rounded-sm cursor-pointer  p-3">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                stroke="currentColor" class="size-6">
                                <path stroke-linecap="round" stroke-linejoin="round"
